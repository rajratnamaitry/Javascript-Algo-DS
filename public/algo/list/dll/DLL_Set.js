 ...
 *  
 * This function 
 * should accept an index and a value and update the value of the node in the DoublyLinkedList at the index 
 * with the new value. It should return true if the node is updated successfully, or false if an invalid index 
 * is passed in.
 * 
 */
class Node{
